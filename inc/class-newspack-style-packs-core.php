...
class Newspack_Style_Packs_Core {
	...
	public function get_preview_style() {
		...
		// return $this->style;
		// This approach seems to lose the current previewed pack
		// I think related to: https://core.trac.wordpress.org/ticket/24844
		// However, switching to returning current mod could be problematic.
