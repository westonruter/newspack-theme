...
function newspack_get_the_archive_title() {
	if ( is_category() ) {
		$title = esc_html__( 'Category Archives: ', 'newspack' ) . '<span class="page-description">' . single_term_title( '', false ) . '</span>';
	} elseif ( is_tag() ) {
		$title = esc_html__( 'Tag Archives: ', 'newspack' ) . '<span class="page-description">' . single_term_title( '', false ) . '</span>';
	} elseif ( is_author() ) {
		$title = esc_html__( 'Author Archives: ', 'newspack' ) . '<span class="page-description">' . get_the_author_meta( 'display_name' ) . '</span>';
	} elseif ( is_year() ) {
		$title = esc_html__( 'Yearly Archives: ', 'newspack' ) . '<span class="page-description">' . get_the_date( esc_html_x( 'Y', 'yearly archives date format', 'newspack' ) ) . '</span>';
	} elseif ( is_month() ) {
		$title = esc_html__( 'Monthly Archives: ', 'newspack' ) . '<span class="page-description">' . get_the_date( esc_html_x( 'F Y', 'monthly archives date format', 'newspack' ) ) . '</span>';
	} elseif ( is_day() ) {
